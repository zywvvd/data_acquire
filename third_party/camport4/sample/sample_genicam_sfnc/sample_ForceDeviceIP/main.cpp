        ...
        if (TYForceDeviceIP(hIface, mac, newIP, newNetmask, newGateway) == TY_STATUS_OK) {
            ...
            if(open_needed){
              ...
              if(TYOpenDeviceWithIP(hIface, newIP, &hDev) == TY_STATUS_OK){
                ...
                ASSERT_OK( TYIntegerSetValue(hDev, "GevPersistentIPAddress", ip32) );
                ...
                ASSERT_OK( TYIntegerSetValue(hDev, "GevPersistentSubnetMask", ip32) );
                ...
                ASSERT_OK( TYIntegerSetValue(hDev, "GevPersistentDefaultGateway", ip32) );
